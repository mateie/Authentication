...
class ValRsoAuthUser {
    ...
    LoginForm(username, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            //cookie
            const CookieResponse = yield this.ValRsoAxios.post('https://auth.riotgames.com/api/v1/authorization', {
            ...
            //token
            const TokenResponse = yield this.ValRsoAxios.put('https://auth.riotgames.com/api/v1/authorization', {
                'type': 'auth',
                'username': username,
                'password': password,
                'remember': true,
...
exports.ValRsoAuthUser = ValRsoAuthUser;
