...
class RsoAuthCookie {
    ...
    ReAuth() {
        return __awaiter(this, void 0, void 0, function* () {
            //token
            const TokenResponse = yield this.RsoAxios.post('https://auth.riotgames.com/api/v1/authorization', {
...
exports.RsoAuthCookie = RsoAuthCookie;
